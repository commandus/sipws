...
/* Define to 1 if you have the <websocketpp/version.hpp> header file. */
#define HAVE_WEBSOCKETPP_VERSION_HPP 1
...
#define PACKAGE_NAME "sipws"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "sipws 0.5"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "sipws"
